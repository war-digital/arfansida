...
const CONST_GROOM_NICKNAME = "Arfan";

const WEDDING_CONFIG = {
    weddingDate: "2026-07-31T09:30:00+08:00", // Format: YYYY-MM-DDTHH:mm:ss+timezone
    couple: {
        groom: {
            nickname: "Arfan",
            fullName: "Moh. Arfan",
            father: "Bapak Jahir A. Binhuat (Alm)",
            mother: "Ibu Dawia",
            instagram: "Moh_arfan",
            photo: "groom.webp"
        },
        bride: {
            nickname: "Sida",
            fullName: "Nurhasida HS, SH",
            father: "Bapak Abd. Samad HS, SH",
            mother: "Ibu Sumiati Lakupe",
            instagram: "Nurhasida_hs",
            photo: "bride.webp"
        }
    },
    events: {
        akad: {
            date: "Jum'at, 31 Juli 2026",
            time: "09.30 WITA - Selesai",
            locationName: "Dusun Salusu",
            address: "Dusun Salusu Desa Lampasio",
            mapUrl: "https://maps.app.goo.gl/jpaoTZtDVrNkgG8E9?g_st=ac",
            calendarTitle: "Akad Nikah Arfan & Sida",
            calendarStart: "2026-07-31T09:30:00"
        },
        resepsi: {
            date: "Jum'at, 31 Juli 2026",
            ...
            address: "Dusun Salusu Desa Lampasio",
            mapUrl: "https://maps.app.goo.gl/jpaoTZtDVrNkgG8E9?g_st=ac",
            calendarTitle: "Resepsi Pernikahan Arfan & Sida",
            calendarStart: "2026-07-31T19:30:00"
        }
    },
    gifts: [
        {
            bankName: "BANK BRI",
            accountNumber: "022701015898533",
            accountHolder: "a.n. NURHASIDA HS",
            id: "bank-acc-1"
        },
        {
            bankName: "BANK MANDIRI",
            accountNumber: "1510021798167",
            accountHolder: "a.n. MOH ARFAN",
            id: "bank-acc-2"
        }
    ],
    // Array of 12 gallery images
    gallery: [
        { src: "g1.jpg", caption: "Kebersamaan Arfan & Sida" },
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    let mainBgSlideshowInterval;
    function startMainBgSlideshow() {
        if (mainBgSlideshowInterval) {
            clearInterval(mainBgSlideshowInterval);
        }
        const slides = document.querySelectorAll("#main-bg-slideshow .main-bg-slide");
        if (slides.length <= 1) return;
        ...
        mainBgSlideshowInterval = setInterval(() => {
            slides[activeIndex].classList.remove("active");
            activeIndex = (activeIndex + 1) % slides.length;
            slides[activeIndex].classList.add("active");
        }, 4000); // Cross-fade photo every 4 seconds
    }
    ...
    const initOpenInvitationButton = () => {
        ...
        if (btnOpen) {
            btnOpen.addEventListener("click", () => {
                ...
                // Animate Cover 2 out and unmount from layout
                if (coverScreen2) {
                    coverScreen2.classList.add("unlocked");
                    setTimeout(() => {
                        coverScreen2.classList.add("hidden");
                    }, 1000);
                }
                ...
                if (mainContent) {
                    ...
                    setTimeout(() => {
                        ...
                        // Start full-screen main page photo slideshow background
                        startMainBgSlideshow();
